...
var $author$project$Sample$Sample = F4(
	function (artist, album, title, year) {
		return {album: album, artist: artist, title: title, year: year};
	});
var $elm$json$Json$Decode$decodeString = _Json_runOnString;
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$map4 = _Json_map4;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Sample$decodeSample = function (sample) {
	return A2(
		$elm$json$Json$Decode$decodeString,
		A5(
			$elm$json$Json$Decode$map4,
			$author$project$Sample$Sample,
...
var $author$project$Sample$extractSample = function (result) {
	if (result.$ === 'Err') {
		return {album: 'default', artist: 'default', title: 'default', year: 'default'};
	} else {
		var sample = result.a;
		return sample;
	}
...
var $author$project$Sample$isNotDefaultSample = function (sample) {
	return (function ($) {
		return $.artist;
...
var $author$project$Main$init = function (fileData) {
	var decodedSamples = A2(
		$elm$core$List$map,
		$author$project$Sample$decodeSample,
		A2($elm$core$String$split, '\n', fileData));
	return _Utils_Tuple2(
		{
			samples: A2(
				$elm$core$List$filter,
				$author$project$Sample$isNotDefaultSample,
				A2($elm$core$List$map, $author$project$Sample$extractSample, decodedSamples))
		},
...
var $author$project$TopAlbums$AlbumData = F3(
	function (name, artist, quantity) {
		return {artist: artist, name: name, quantity: quantity};
	});
...
var $author$project$TopAlbums$getArtistbyAlbumName = F2(
	function (albumName, samples) {
		var defaultSample = A4($author$project$Sample$Sample, 'Unknown album', 'Unknown artist', 'Unknown title', 'Unknown year');
		return A2(
...
var $author$project$TopAlbums$getAlbumDataByName = F2(
	function (name, samples) {
		return A3(
			$author$project$TopAlbums$AlbumData,
			name,
			A2($author$project$TopAlbums$getArtistbyAlbumName, name, samples),
...
var $author$project$TopAlbums$getAlbumsSet = function (samples) {
	return $Chadtech$unique_list$List$Unique$fromList(
		A2(
			$elm$core$List$map,
			function (s) {
				return function ($) {
...
var $author$project$TopAlbums$getAlbumsDataList = function (samples) {
	var albums = $author$project$TopAlbums$getAlbumsSet(samples);
	return A2(
		$elm$core$List$map,
		function (a) {
			return A2($author$project$TopAlbums$getAlbumDataByName, a, samples);
		},
		$Chadtech$unique_list$List$Unique$toList(albums));
};
var $elm$html$Html$h2 = _VirtualDom_node('h2');
var $elm$html$Html$p = _VirtualDom_node('p');
var $author$project$TopAlbums$compareAlbumDataByQuantity = F2(
	function (a, b) {
		var _v0 = _Utils_cmp(
			function ($) {
				return $.quantity;
...
var $author$project$TopAlbums$sortAlbumsByQuantity = function (albums) {
	return A2($elm$core$List$sortWith, $author$project$TopAlbums$compareAlbumDataByQuantity, albums);
};
...
var $author$project$Main$albumsChart = function (model) {
	var topAlbums = A2(
		$elm$core$List$take,
		10,
		$elm$core$List$reverse(
			$author$project$TopAlbums$sortAlbumsByQuantity(
				$author$project$TopAlbums$getAlbumsDataList(model.samples))));
	var htmlTopAlbumsList = A2(
		$elm$core$List$map,
		function (a) {
			return A2(
				$elm$html$Html$p,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('caps-formated')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('panel-top-albums')
			]),
		_Utils_ap(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Top 10 Albums')
						]))
				]),
			htmlTopAlbumsList));
};
var $author$project$TopArtists$ArtistData = F2(
	function (name, quantity) {
		return {name: name, quantity: quantity};
	});
var $author$project$TopArtists$getArtistDataByName = F2(
	function (name, samples) {
		return A2(
			$author$project$TopArtists$ArtistData,
			name,
			$elm$core$List$length(
				A2(
					$elm$core$List$filter,
...
var $author$project$TopArtists$getArtistsSet = function (samples) {
	return $Chadtech$unique_list$List$Unique$fromList(
		A2(
			$elm$core$List$map,
			function (s) {
...
var $author$project$TopArtists$getArtistsDataList = function (samples) {
	var artists = $author$project$TopArtists$getArtistsSet(samples);
	return A2(
		$elm$core$List$map,
		function (a) {
			return A2($author$project$TopArtists$getArtistDataByName, a, samples);
		},
		$Chadtech$unique_list$List$Unique$toList(artists));
};
var $author$project$TopArtists$compareArtistDataByQuantity = F2(
	function (a, b) {
		var _v0 = _Utils_cmp(
			function ($) {
				return $.quantity;
...
var $author$project$TopArtists$sortArtistsByQuantity = function (artists) {
	return A2($elm$core$List$sortWith, $author$project$TopArtists$compareArtistDataByQuantity, artists);
};
var $author$project$Main$artistsChart = function (model) {
	var topArtists = A2(
		$elm$core$List$take,
		10,
		$elm$core$List$reverse(
			$author$project$TopArtists$sortArtistsByQuantity(
				$author$project$TopArtists$getArtistsDataList(model.samples))));
	var htmlTopArtistsList = A2(
		$elm$core$List$map,
		function (a) {
			return A2(
				$elm$html$Html$p,
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('panel-top-artists')
			]),
		_Utils_ap(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Top 10 Artists')
						]))
				]),
			htmlTopArtistsList));
};
...
var $author$project$YearChart$chartConfig = {
...
var $author$project$YearChart$getMaxYear = function (samples) {
	var years = A2(
		$elm$core$List$map,
		function (s) {
			return A2(
...
var $author$project$YearChart$getMinYear = function (samples) {
	var years = A2(
		$elm$core$List$map,
		function (s) {
			return A2(
	...
	return A2(
		$elm$core$Maybe$withDefault,
		0,
		$elm$core$List$minimum(years));
};
var $author$project$YearChart$Point = F2(
	function (year, quantity) {
		return {quantity: quantity, year: year};
	});
var $elm$core$Debug$toString = _Debug_toString;
var $author$project$YearChart$getPointByYear = F2(
	function (year, samples) {
		return A2(
			$author$project$YearChart$Point,
			year,
			$elm$core$List$length(
				A2(
					$elm$core$List$filter,
...
var $author$project$YearChart$createLine = function (samples) {
	var years = A2(
		$elm$core$List$range,
		$author$project$YearChart$getMinYear(samples),
		$author$project$YearChart$getMaxYear(samples));
	return A2(
		$elm$core$List$map,
		function (y) {
			return A2($author$project$YearChart$getPointByYear, y, samples);
		},
		years);
};
...
var $author$project$YearChart$chart = function (samples) {
	var line = $author$project$YearChart$createLine(samples);
	return A2(
		$terezka$line_charts$LineChart$viewCustom,
		$author$project$YearChart$chartConfig,
		_List_fromArray(
			[
				A4(
				$terezka$line_charts$LineChart$line,
				$terezka$line_charts$LineChart$Colors$pink,
				$terezka$line_charts$LineChart$Dots$diamond,
				'Top years',
				A2(
					$elm$core$List$filter,
					function (p) {
					...
					$author$project$YearChart$createLine(samples)))
			]));
};
var $author$project$Main$yearChart = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('panel-year-chart')
			]),
		_Utils_ap(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Samples/year')
						]))
				]),
			_List_fromArray(
				[
					$author$project$YearChart$chart(model.samples)
				])));
};
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$yearChart(model),
				$author$project$Main$artistsChart(model),
				$author$project$Main$albumsChart(model)
			]));
};
